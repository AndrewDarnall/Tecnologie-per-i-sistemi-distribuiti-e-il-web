...
int main()
{
    ...
    do
    {
        ssize_t remainingBytes = totalBytesRead - totalBytesWritten;
        ...
        bytesWritten = write(clientSocketDescriptor, buffer + totalBytesWritten, totalBytesRead - totalBytesWritten);
